...
Scores: `[F? M? T?]` per idea, each out of 10. **F**un to build, **M**oney potential (direct or indirect), **T**echnically challenging. Ideas weak on every axis (max ≤ 3) have been pruned.
...
* Temp splitwise (can also be used to host lists and shit) — https://github.com/sarthakagrawal927/temp-splitwise `[F5 M3 T4]`
* A shareable music list (with DnD realtime editing, different source handling) — https://github.com/sarthakagrawal927/musicDnD/ `[F6 M2 T5]`
* A location tracking app — https://github.com/sarthakagrawal927/location-tracker-app `[F4 M3 T4]`
* An app that lets you find relevant places based on user feedback, something like nomad list but for similar stuff — https://github.com/sarthakagrawal927/maps-server `[F6 M5 T4]`
...
**Dropped this pass (max F/M/T ≤ 3):**
- airport-destination contextual ads
- podcaster embedded at all places
